...
# Define constants
EDUCATION_DATA_PATH = "API_SE.PRM.ENRR_DS2_en_csv_v2_5363695.csv"
EXPENDITURE_DATA_PATH = "API_SE.XPD.TOTL.GD.ZS_DS2_en_csv_v2_5358378.csv"
YEARS = ["1990", "2000", "2012", "2013", "2014", "2015", "2016", "2017", "2018","2019","2020"]
COUNTRY = "Pakistan"
...
def kmeans_cluster(df, no_clusters, labels):
   ...
   '''
    ...
    plt.show()
fname1 = "API_SE.ADT.LITR.ZS_DS2_en_csv_v2_5358397.csv"
fname2 = "API_SE.PRM.ENRR_DS2_en_csv_v2_5363695.csv"
...
df_fit = pd.merge(education_df["2020"], govexpenditure_df["2020"], right_index=True, left_index=True)
kmeans_cluster(df_fit, 4, labels)

# Generate random data for demonstration
np.random.seed(42)
education_df = pd.DataFrame({"2020": np.random.rand(10)})
govexpenditure_df = pd.DataFrame({"2020": np.random.rand(10)})

# Sort the data by the x-axis variable
sorted_education = education_df.sort_values(by="2020")
sorted_expenditure = govexpenditure_df.loc[sorted_education.index]

# Plot the data as a line plot
plt.figure(figsize=(6.0, 6.0))
plt.plot(sorted_education["2020"], sorted_expenditure["2020"])
plt.xlabel("Literacy Rate")
plt.ylabel("Government Expenditure on Education")
plt.title("Education Expenditure vs. Literacy Rate in 2020")
plt.show()